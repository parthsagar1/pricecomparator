...
class Price_compare:
    ...
    def find(self):
        ...
        entry_amzn.grid(row=6, column=1,sticky=W)
        ...
        try:
            ...
            self.variable_amzn.set('Product not found')
        try:
            self.variable_flip.set(self.matches_flip[0])
        except:
            self.variable_flip.set('Product not found')
    ...
    def search(self):
        ...
        try:
            ...
            self.var_amzn.set('None')
            self.title_amzn_var.set('product not found')
